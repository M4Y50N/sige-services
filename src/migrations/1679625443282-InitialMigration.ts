...
export class InitialMigration1679625443282 implements MigrationInterface {
    name = 'InitialMigration1679625443282'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "phone" ("id" SERIAL NOT NULL, "cellPhone" character varying(11) NOT NULL, "landLine" character varying(15) NOT NULL, CONSTRAINT "UQ_4b457889d39530987fb3f9b180b" UNIQUE ("cellPhone"), CONSTRAINT "UQ_2ae155e734e8d37c61ec91843f2" UNIQUE ("landLine"), CONSTRAINT "PK_f35e6ee6c1232ce6462505c2b25" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user_infos" ("id" SERIAL NOT NULL, "name" character varying(45) NOT NULL, "cpf" character varying(11) NOT NULL, "birthDate" date NOT NULL, "phoneId" integer, "academicId" integer, "addressId" integer, CONSTRAINT "UQ_c49c7c652c895560f1cef2544b2" UNIQUE ("cpf"), CONSTRAINT "REL_7278178ce47139edffb26e8761" UNIQUE ("phoneId"), CONSTRAINT "REL_ced452591dbc36372302ade4c0" UNIQUE ("academicId"), CONSTRAINT "REL_b1e7826c6e000efbdb948060b2" UNIQUE ("addressId"), CONSTRAINT "PK_dff10c2d65f58909fbd2f88bff5" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "users" ("id" SERIAL NOT NULL, "userName" character varying(45) NOT NULL, "password" character varying NOT NULL, "email" character varying(30) NOT NULL, "isAdmin" boolean NOT NULL DEFAULT false, "createdAt" date NOT NULL DEFAULT now(), "updatedAt" date NOT NULL DEFAULT now(), "deletedAt" date, "userInfosId" integer, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "REL_4329ac939f3429725d8afbcd61" UNIQUE ("userInfosId"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
